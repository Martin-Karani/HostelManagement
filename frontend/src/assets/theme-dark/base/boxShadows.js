...
/**
 * The base box-shadow styles for the Hostel Management PRO React.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire Hostel Management PRO React using thie file.
 */
